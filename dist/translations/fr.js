export default {
  ...
  editor: {
    ...
    show_car_state: "Afficher l'état de la voiture",
    ...
    charging_image: "Image de chargement",
    enter_image_url: "Entrez l'URL de l'image",
    upload_image: "Télécharger une image",
    entity_settings: "Paramètres de l'entité",
    ...
    charging_status: "Statut de chargement",
    location: "Emplacement",
    mileage: "Kilométrage",
    car_state: "État de la voiture",
    charge_limit: "Limite de charge",
    ...
    barBorderColor: "Couleur de la bordure de la barre",
    ...
    car_state_description: "Sélectionnez l'entité qui représente l'état actuel de votre véhicule (par exemple, garé, en conduite, en charge).",
    icon_grid_description: "Ajoutez des entités à la grille d'icônes. Recherchez et sélectionnez des entités à ajouter. Utilisez la poignée de déplacement pour réorganiser les entités. Cliquez sur l'icône pour la changer, et utilisez (×) pour supprimer une entité de la grille.",
    ...
    icon_gap_size: "Taille de l'écart entre les icônes",
    icon_gap_description: "Définissez l'écart entre les icônes en pixels.",
